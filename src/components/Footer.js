  ...
  return (
    <footer className="bg-gray-900 text-gray-300 mt-16">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-8 md:grid-cols-4">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Providing quality tuition for Nursery to Class V students.
            Personal attention, strong basics, and a safe learning environment
            for young minds in Chennai.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>📞 +91 80120 11705</li>
            <li>🕘 Mon – Sat: 4 PM – 8 PM</li>
            <li>📧 brighttuition@gmail.com</li>
          </ul>
      ...
      <div className="border-t border-gray-700 text-center py-4 text-sm">
        © {new Date().getFullYear()} Bright Tuition Center. All rights reserved.
      </div>
    </footer>
  );
}
